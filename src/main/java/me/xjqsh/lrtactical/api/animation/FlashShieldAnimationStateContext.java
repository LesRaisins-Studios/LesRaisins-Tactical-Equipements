...
public class FlashShieldAnimationStateContext extends ItemAnimationStateContext {
    ...
    public void setCurrentItem(ItemStack currentItem) {
        ...
        if (currentItem.getItem() instanceof ShieldItem shieldItem) {
            this.prepareTime = shieldItem.getMaxUsingTick(currentItem);
        }
    }
